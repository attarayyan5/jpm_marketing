    ...
    <main className="min-h-screen flex items-center justify-center px-4" style={{ backgroundColor: 'var(--bg-primary)' }}>
      ...
      <div className="relative w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold font-display" style={{ color: 'var(--text-heading)' }}>Admin Login</h1>
          <p className="text-sm mt-1" style={{ color: 'var(--text-muted)' }}>JP Multiservices Management Portal</p>
        </div>
        <form onSubmit={handleSubmit} className="glass-card p-8 space-y-5">
          ...
          <div>
            ...
            <div className="relative">
              <div className="absolute left-3 top-1/2 -translate-y-1/2" style={{ color: 'var(--text-muted)' }}><FaLock className="text-sm" /></div>
